<head>
    ...
    @font-face {
        ...
        font-weight: 100;
        src: url("http://recessmobileapp.com/fonts/GothamNarrowBook.otf") format("opentype");
    }
                ...
                <tbody>
                    <tr>
                        <td align="center" class="vervelogoplaceholder" height="143"
                            ...
                            valign="middle"><span class="sg-image"
                                data-imagelibrary="%7B%22width%22%3A%22160%22%2C%22height%22%3A34%2C%22alt_text%22%3A%22Verve%20Wine%22%2C%22alignment%22%3A%22%22%2C%22border%22%3A0%2C%22src%22%3A%22https%3A//marketing-image-production.s3.amazonaws.com/uploads/79d8f4f889362f0c7effb2c26e08814bb12f5eb31c053021ada3463c7b35de6fb261440fc89fa804edbd11242076a81c8f0a9daa443273da5cb09c1a4739499f.png%22%2C%22link%22%3A%22%23%22%2C%22classes%22%3A%7B%22sg-image%22%3A1%7D%7D"><a
                                    href="{{url('/')}}" target="_blank"><img alt="Recess" height="60"
                                        src="{{asset('images/app_icon.png')}}"
                                        style="border-width: 0px; width: 60px; height: 60px;" width="60"></a></span>
                        </td>
                    </tr>
                    <tr>
                        <td class="one-column"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="inner contents center"
                                            ...
                                            <center>
                                                <p class="h1 center"
                                                    style="Margin:0;text-align:center;font-family:'flama-condensed','Arial Narrow',Arial;font-weight:100;font-size:30px;Margin-bottom:26px; color: #125aa6;">
                                                    Join your friend on Recess </p>
                                                ...
                                                <p class="description center"
                                                    ...
                                                    <span
                                                        style="color: rgb(161, 168, 173); font-family: Muli, &quot;Arial Narrow&quot;, Arial; font-size: 15px; text-align: center; background-color: rgb(255, 255, 255);">{{$username}}
                                                        has invited you to join Recess. You can click on the link bellow
                                                        to get the app from store</span>
                                                </p>
                                                <!--[if (gte mso 9)|(IE)]><br>&nbsp;<![endif]--><span class="sg-image"
                                                    data-imagelibrary="%7B%22width%22%3A%22260%22%2C%22height%22%3A54%2C%22alt_text%22%3A%22Reset%20your%20Password%22%2C%22alignment%22%3A%22%22%2C%22border%22%3A0%2C%22src%22%3A%22https%3A//marketing-image-production.s3.amazonaws.com/uploads/c1e9ad698cfb27be42ce2421c7d56cb405ef63eaa78c1db77cd79e02742dd1f35a277fc3e0dcad676976e72f02942b7c1709d933a77eacb048c92be49b0ec6f3.png%22%2C%22link%22%3A%22%23%22%2C%22classes%22%3A%7B%22sg-image%22%3A1%7D%7D"><a
                                                        href="{{$app_link}}" target="_blank">Join Recess</a></span>
                    ...
                    <?php
                        ...
                        $ph = $settings->where('name', 'CONTACT_NO')->first();
                        ...
                        <td
                            ...
                            <center>
                                <p
                                    ...
                                    <nobr><a class="tel" href="tel:2128102899"
                                            style="color:#a1a8ad;text-decoration:none;" target="_blank"><span
                                                style="white-space: nowrap">{{($ph) ? $ph->value : ''}}</span></a>
                                    </nobr>
                                </p>

                                <p
                                    style="font-family:'Muli',Arial,sans-serif;Margin:0;text-align:center;Margin-right:auto;Margin-left:auto;font-size:15px;color:#a1a8ad;line-height:23px;">
                                    or email <a href="mailto:{{($email) ? $email->value : ''}}"
                                        style="color:#a1a8ad;text-decoration:underline;"
                                        target="_blank">{{($email) ? $email->value : ''}}</a></p>
                                ...
                                <p
                                    ...
                                    © Recess <span
                                        style="white-space: nowrap">{{($address) ? $address->value : ''}}</span>
                            </center>
                        </td>
                    </tr>
                    <!-- whitespace -->
