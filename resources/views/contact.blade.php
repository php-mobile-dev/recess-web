                                        ...
                                        <td class="inner contents center"
                                            ...
                                            <center>
                                                ...
                                                <p class="description center"
                                                    ...
                                                    <span
                                                        style="color: rgb(161, 168, 173); font-family: Muli, &quot;Arial Narrow&quot;, Arial; font-size: 15px; text-align: center; background-color: rgb(255, 255, 255);">{{$user_mail ?? ''}}
                                                        has sent us the following message: <br />
                                                        {{$user_message ?? ''}}
                                                    </span>
                                                </p>
                                            </center>
